...
public class Rectangle implements ShapeInterface{
    ...
    private String DEF_type = "DEFAULT RECTANGLE";
    ...
    public Rectangle() {
        ...
        this.type = DEF_type;
        this.area = this.x_dim * this.y_dim;
    }

    // Parameterized constructor
    public Rectangle(String aType, double aX, double aY) {
        this.setType(aType);
    ...
    public void setXDimension(double aX) {
        if (aX > 0.0)
            ...
            System.out.println("RECTANGLE: invalid[" + aX + "], using default x-dimension");
    ...
    public void setYDimension(double aY) {
        if (aY > 0.0)
            ...
            System.out.println("RECTANGLE: invalid[" + aY + "], using default y-dimension");
            this.y_dim = DEF_y_dim;
        }
    }
    public void setType(String aType) {
        if (aType.equalsIgnoreCase("Rectangle"))
            this.type = aType;
        else
            this.type = DEF_type;
    }
